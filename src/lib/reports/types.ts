...
export const REPORT_WARNING =
  `للحفاظ على أقصى أداء واستقرار لجهازك، يُرجى عدم تحديث الويندوز، تغيير قطع الهاردوير بدون الرجوع إلينا، أو استخدام أي برامج تنظيف وتعديلات "تويك"؛ حيث قد يؤدي ذلك لتعارضات ومشاكل عشوائية تُلغي التعديلات الخاصة بنا. كما ننصحك بتجنب ترك برامج غير ضرورية تعمل في الخلفية (مثل برامج التصوير أو عزل الصوت كـ نفيديا برودكاست)، لأنها تستهلك من موارد الجهاز وتؤثر سلباً على الأداء، ويُفضل تشغيلها عند الحاجة فقط. نحن هنا دائماً لخدمتك ودعمك، فلا تتردد في التواصل معنا لأي مساعدة!`;
